...
if(nodes['defaultMaterial'].material){
  ...
  // t.alphaMap= pugImgTexture.alphaMap
  t.normalMap= pugImgTexture.normalMap

  console.log(t)
  nodes['defaultMaterial'].material=t
  // nodes['defaultMaterial'].material.color = {isColor: true, r: 0.8, g: 0.1, b: 0.8}
  nodes['defaultMaterial'].scale.x = -1 // flip normal
}

//eyes
if(nodes['Shar_Pei_Shar_Pei16_0'].material){
  nodes['Shar_Pei_Shar_Pei16_0'].material.color = {isColor: true, r: 0.1, g: 0.1, b: 0.2}
}

if(nodes['Shar_Pei_Shar_Pei18_0'].material){
  nodes['Shar_Pei_Shar_Pei18_0'].material.color = {isColor: true, r: 0.1, g: 0.1, b: 0.2}
}
